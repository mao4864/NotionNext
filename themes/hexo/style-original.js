...
const Style = () => {
  ...
  return (
    <style jsx global>{`
      ...
      /* ===== 首页Hero区域文字位置优化 ===== */
      /* Seaward品牌文字移到封面顶部居中，加粗 */
      #theme-hexo .hero-title,
      #theme-hexo .site-title,
      #theme-hexo .banner-title {
        position: absolute;
        top: 12%;
        left: 50%;
      ...
      /* 欢迎文字移到右侧空白区域 + 背景框（打字动画容器） */
      #theme-hexo .hero-subtitle,
      #theme-hexo .site-description,
      #theme-hexo .banner-desc {
        position: absolute;
        right: 8%;
        top: 40%;
        max-width: 240px;
