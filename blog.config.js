// 注: process.env.XX是Vercel的环境变量，配置方式见：https://docs.tangly1024.com/article/how-to-config-notion-next#c4768010ae7d44609b744e79e2f9959a
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '视频工具站', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'AE插件 · 视频教程 · 实用工具 · LOL绝活', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://tangly1024.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'AE插件,PR预设,视频教程,实用工具,LOL,绝活', // 网站关键词 英文逗号隔开
